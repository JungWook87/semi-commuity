...
*********************************************************************************/
;(function($) {
    $.fn.d_tabMotionWideBanner = function(E) {
        var F = {
            key: '',
            motionSpeed: 1300,
            motionDelay: 300,
        ...
        return this.each(function() {
            ...
            ;function setEnterFrame() {
                z = setInterval(changeCurrent, F.autoRollingTime)
            }
            ;function setAnimation() {
                ...
                var d, _oldImg;
                if (B == "next") {
                    b.css('left', a).show().stop().delay(F.motionDelay).animate({
                        'left': 0
                    }, F.motionSpeed, 'easeInOutExpo', function() {
                        y = x;
                        C = true
                    });
                    c.css('margin-left', 0);
                    d = r.eq(y);
                    d.css('left', 0).stop().delay(F.motionDelay).animate({
                        'left': -a
                    }, F.motionSpeed, 'easeInOutExpo', function() {
                        $(this).hide()
                    });
                    _oldImg = d.find('.motion');
                    _oldImg.stop().animate({
                        'margin-left': -a
                    }, F.motionSpeed, 'easeInOutExpo')
                } else {
                    b.css('left', -a).show().stop().delay(F.motionDelay).animate({
                        'left': 0
                    }, F.motionSpeed, 'easeInOutExpo', function() {
