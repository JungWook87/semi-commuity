...
*********************************************************************************/
;(function($) {
    $.fn.DB_tabSlideStepBanner = function(K) {
        var L = {
            moveSpeed: 500,
        ...
        return this.each(function() {
            ...
            var v;
            var w = r.length;
            var x = r.width() + String(r.css('margin-right')).slice(0, -2) * 1;
            var y = [];
            var z = [];
            var A = 1;
            var B;
                ...
                if (w > L.limitNum) {
                    for (var i = 0; i < w; i++) {
                        if (D == "next") {
                            ...
                            ;z[i].css('left', y[i] - x * E).stop().animate({
                                'left': y[i]
                            }, F, G, function() {
                                if (r.index($(this)) == 0) {
                                    A = 1
